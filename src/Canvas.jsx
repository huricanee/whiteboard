          ...
          <span
            ...
            onInput={(e) => {
              ...
              if (el) {
                ...
                onUpdateNode(node.id, { height: snapped });
              }
            }}
          >
            {node.text}
  ...
  return (
    ...
    >
      <div
        ...
        style={{
          backgroundImage: `radial-gradient(circle at 0 0, rgba(255,255,255,0.18) 1px, transparent 1px)`,
      ...
      >
        ...
        <div className="region-layer">
          {Object.values(regions).map((region) => {
            ...
            return (
              <div key={region.id} className={`wb-region${isRegionSelected ? ' selected' : ''}`}
